...
## Tech Stack 
- Python 3.10+
- Pandas / NumPy – Data handling and cosine similarity.
- Streamlit – Web app framework.

## How It Works 
- User selects a movie from the dropdown.
- System computes similarity scores using cosine similarity.
- Top N similar movies are displayed as recommendation.

## Example Output 

- If a user selects "Inception", The System recommends:
- `Interstellar`
- `The Dark Knight`
